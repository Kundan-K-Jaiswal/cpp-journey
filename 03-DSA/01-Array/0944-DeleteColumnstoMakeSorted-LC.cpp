...
// 944. Delete Columns to Make Sorted  |  Platform : LeetCode
...
// Solution Core : We will check for each string same index if the alphabet is sorted lexicographically then check
// other two words, and if not increase count and check for other index.

// Time Complexity : O(m*n) -> m = size of str, n = size of word
